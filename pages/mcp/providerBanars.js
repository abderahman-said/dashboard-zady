...
const ProviderBanars = () => {
  const dispatch = useDispatch();
  //   const { HeadersArr } = useSelector((state) => state.ControlPanal);
  const { Url, HeaderBannersArr } = useSelector((state) => state.HomeSlice);
  ...
  }, [router, dispatch, HeaderBannersArr]);
  ...
  const SendData = () => {
    ...
    // console.log(data);
    dispatch(saveHeaderBanner(data))
      .unwrap()
      .then(() => {
        dispatch(getHeaderBanners());
        setName("");
  ...
  const SendUpdateData = () => {
    ...
    console.log(data)
    dispatch(updateHeaderBanner(data))
      .unwrap()
      .then(() => {
        setTimeout(() => {
          dispatch(getHeaderBanners()).unwrap().then(() => {
            setName("");
            setDescription("");
            setImage("");
              ...
              <div className="card">
                <DataTable
                  ...
                  onSelectionChange={(e) => {
                    ...
                    setDescription(e.value.link);
                    setImage(e.value.image);
                  }}
                  value={HeaderBannersArr}
                  paginator
      ...
      <>
        ...
        >
          <div className={styles.Dialog_Content}>
            ...
            <div className={styles.input_Section}>
              <label htmlFor="description"> لينك</label>
              <input
                type={"number"}
                id={"description"}
                width={100}
